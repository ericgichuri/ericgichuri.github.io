...
gsap.from('.landing',{duration: 0.3, x:'-100vw',background:'#000088' ,delay:0.2,ease:'power2.in'})
gsap.from('.text-landing',{duration:0.4,y:'50px',delay:0.6,opacity:0,ease:'power'})
gsap.from('.img1',{duration:0.4,y:'50px',delay:0.6,opacity:0,ease:'power'})
...
gsap.from('img',{'duration':0.5,x:'-20px',opacity:0,delay:6,ease:'power2.in',stagger:.2})
gsap.from('button',{'duration':0.5,x:'100vw',delay:6,ease:'power2.in',stagger:.2})
