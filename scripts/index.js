...
gsap.from('.landing',{duration: 0.3, x:'-100vw',background:'#000088' ,delay:0.0,ease:'power2.in'})
gsap.from('.text-landing',{duration:0.4,y:'50px',delay:0.5,opacity:0,ease:'power'})
gsap.from('.img1',{duration:0.4,y:'50px',delay:0.4,opacity:0,ease:'power'})
gsap.to('.landing',{duration: 0.5, height:'0px',display:'none',delay:1.5,ease:'power2.in'})
...
gsap.from('img',{'duration':0.5,x:'-20px',opacity:0,delay:6,ease:'power2.in',stagger:.1})
gsap.from('button',{'duration':0.5,x:'100vw',delay:6,ease:'power2.inOut',stagger:.2})

gsap.from('.container1 h3',{duration:0.6,y:'50px',delay:4.4,opacity:0,ease:'power',stagger:.3})
gsap.from('.container1 h4',{duration:0.6,y:'50px',delay:5.1,opacity:0,ease:'power',stagger:.3})
gsap.from('.container1 h5',{duration:0.6,y:'50px',delay:5.7,opacity:0,ease:'power',stagger:.3})
gsap.from('.container1 h6',{duration:0.6,y:'50px',delay:5.9,opacity:0,ease:'power',stagger:.3})
gsap.from('.container1 p',{duration:0.6,y:'50px',delay:6.1,opacity:0,ease:'power',stagger:.3})
